...
const Card = ({
  ...
  const defaultBgColors = {
    orange: "bg-bg-secondary",
    blue: "bg-bg-secondary",
    purple: "bg-bg-secondary",
  };
  ...
  return (
    ...
    >
      <div className="bg-bg-primary p-2 rounded-[25px] border border-border">
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-text-primary leading-none mb-[10px]">
            {title}
          </h3>
          <p className="text-text-secondary text-sm/5 tracking-tight">
            {description}
          </p>
        </div>
      </div>
...
export default function HowItWorks({
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={`bg-bg-primary max-md:pt-10 max-md:pb-25 md:py-20 px-8 relative ${className}`}
      >
        {/* Background Grid to match Hero */}
        <div 
          className="absolute inset-0 bg-[linear-gradient(to_right,#8080801a_1px,transparent_1px),linear-gradient(to_bottom,#8080801a_1px,transparent_1px)] bg-[size:4rem_4rem] pointer-events-none z-0"
        />
        <div className="from-bg-primary pointer-events-none absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r z-0"></div>
        <div className="from-bg-primary pointer-events-none absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l z-0"></div>
